...
const NAVIGATION = {
    admin: [
        ...
        { label: 'Personnel',      icon: Users,      href: '/admin/users' },
    ...
    DRRG: [
        ...
        { label: 'Mon Personnel',  icon: Users,      href: '/drrg/users' },
    ...
    DRCX: [
        ...
        { label: 'Mon Personnel',  icon: Users,      href: '/drcx/users' },
    ...
    DRPD: [
        ...
        { label: 'Mon Personnel',  icon: Users,      href: '/drpd/users' },
