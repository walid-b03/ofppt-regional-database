                        ...
                        <div className="flex flex-col items-start gap-6 sm:flex-row sm:items-center">
                            ...
                            <div className="flex-1 space-y-2">
                                ...
                                <div className="flex flex-wrap items-center gap-3">
                                    <span className="inline-flex items-center gap-1.5 rounded-full border border-white/20 bg-white/10 px-3.5 py-1 text-xs font-medium text-emerald-100 backdrop-blur-sm">
                ...
                {data.complexes?.length > 0 && (
                    <div className="overflow-hidden rounded-xl border border-stone-200 bg-white shadow-sm">
                        <div className="flex items-center gap-3 border-b border-stone-100 px-5 py-4">
                            ...
                            <h3 className="text-sm font-semibold text-stone-900">Complexes ({data.complexes.length})</h3>
                        </div>
                        <div className="flex flex-wrap gap-2 px-5 py-5">
                            {data.complexes.map(complex => (
                                <Link
                                    ...
                                    className="inline-flex items-center gap-1.5 rounded-full bg-violet-50 px-4 py-2 text-xs font-medium text-violet-700 ring-1 ring-inset ring-violet-100 hover:bg-violet-100"
                                >
